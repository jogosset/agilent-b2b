...
// Fixed deployment URL for the commerce-custom-options App Builder action.
// Not read from config.json: that file is periodically regenerated by
// Demo Builder's own mesh-sync automation, which silently drops any keys
// it doesn't know about (observed dropping "custom-options-endpoint").
const CUSTOM_OPTIONS_ENDPOINT = 'https://285361-erpintegration-stage.adobeioruntime.net/api/v1/web/commerce-custom-options/get';
